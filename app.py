...
with about_tab:
    ...
    with right:
        ...
        with st.expander("Experience"):
            st.write("Beats by Dre consumer insights externship · Business founder and owner · Spa operations and customer experience")
        with st.expander("Education"):
            st.write("Certified Data Scientist · Machine Learning & Applied Analytics · Associate of Arts")
        with st.expander("Outside the notebook"):
            st.write("Mountains, music, photography, creative projects, and family life keep me curious and adaptable.")
